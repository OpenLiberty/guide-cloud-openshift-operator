...
https://github.com/OpenLiberty/open-liberty-operator#operator-installation[official GitHub repository^], with a few notes.
First, replace any use of `kubectl` with `oc`. In addition, the namespace to install and watch from should be `guide`.
