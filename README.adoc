...
There are various OpenShift offerings. You can use the https://developers.redhat.com/developer-sandbox[developer sandbox^], which provides
free access to an OpenShift cluster for 30 days. Alternatively, you can gain access to an OpenShift cluster that is hosted on
