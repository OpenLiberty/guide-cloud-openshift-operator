...
Wait until the build completes. You will know it is complete once you see the `Push successful` message. Run the following
command to view the image streams:
