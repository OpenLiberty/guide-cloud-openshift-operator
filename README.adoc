...
inventory   inventory-guide.apps.poops.os.fyre.ibm.com          inventory   9085-tcp                 None
```
...
For example: `http://inventory-guide.apps.poops.os.fyre.ibm.com/inventory/systems`.
