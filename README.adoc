...
For client installation instructions, refer to https://docs.openshift.com/container-platform/4.13/cli_reference/openshift_cli/getting-started-cli.html[the official OpenShift Online documentation^].
...
If your cluster has not installed the https://cert-manager.io[cert-manager^] yet, install it by running the following command that refers to the official https://cert-manager.io/docs/installation[cert-manager installation] documentation:
[role='command']
```
