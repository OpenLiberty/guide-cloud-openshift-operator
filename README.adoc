...
The Open Liberty Operator provides a method of deploying and managing Open Liberty applications on OKD or OpenShift clusters. 
...
deployment defined in an `OpenLibertyApplication` custom resource and reconciling when necessary. To learn more about OpenShift 
