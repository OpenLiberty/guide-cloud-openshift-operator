...
There are various OpenShift offerings. You can use their https://learn.openshift.com/playgrounds/openshift44[online playground^], which provides
...
The uploaded files needs to include the packaged `WAR` application files, which is why you needed to run the Maven commands. The template specifies
